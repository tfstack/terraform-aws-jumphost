...
echo "Starting user_data script execution for Amazon Linux 2023..."
...
echo "Installing SSM Agent for Amazon Linux 2023..."
...
echo "Installing EC2 Instance Connect for Amazon Linux 2023..."
dnf install -y ec2-instance-connect || echo "EC2 Instance Connect installation failed"
%{ endif ~}
...
dnf install -y amazon-cloudwatch-agent || echo "CloudWatch Agent installation failed"
